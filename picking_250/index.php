...
$queryinsertcuvette = "INSERT INTO `picking`(`num_worker`, `id_packing_type`, `quantity`, `date`, `user_balance`, `id_campaign`) VALUES ('$num', '6','$quant','$date','$userid','$camp')";
...
$queryinsertbox = "INSERT INTO `picking`(`num_worker`, `id_packing_type`, `quantity`, `date`, `user_balance`, `id_campaign`) VALUES ('$num', '5','$quant','$date','$userid','$camp')";
...
<html>
<head><title>Picking 250Gr</title></head>
<body>
<form action="index.php" method="post">
<marquee><h2>WELCOME</h2></marquee>
<center><table border="1" width="800" height="800">
<tr>
<td colspan="5" align="center" bgcolor="grey">Picking 250Gr</td>
</tr>
<tr>
